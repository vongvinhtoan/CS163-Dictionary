...
ActivityWordDelConfirm::ActivityWordDelConfirm(ActivityStack& stack, Context context, Intent::Ptr intent, int requestCode)
...
void ActivityWordDelConfirm::buildScene()
{
    // Background layer
...
void ActivityWordDelConfirm::draw()
{
...
bool ActivityWordDelConfirm::update(sf::Time dt)
{
    mSceneGraph->update(dt);
    return false;
}

bool ActivityWordDelConfirm::handleEvent(const sf::Event& event)
{
...
bool ActivityWordDelConfirm::handleRealtimeInput()
{
